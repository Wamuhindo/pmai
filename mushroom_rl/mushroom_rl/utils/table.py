...
class Table(Serializable):
    ...
    """
    def __init__(self, shape, initial_value=1., dtype=None):
        """
        Constructor.
        ...
        """
        self.table = np.random.uniform(low=-1.5, high=-1,size=shape) * initial_value

        self._add_save_attr(table='numpy')

    def __getitem__(self, args):
        #print("table size "+str(self.table.size))
        #print(args)
