...
class EnvironmentSEWDQN(Environment, Serializable):
    ...
    def __init__(self, system=None, system_file=None,
                 ...
                 logger=Logger(), variations=[],max_env_step=10000):
        ...
        self._max_env_step = max_env_step
        ...
        if env_params is not None:
            ...
            with open(env_params_file) as f:
                params = json.load(f)["EnvParameters"]
    ...
    def step(self, _action):
        ...
        self._state = np.array(
            [current_rate_WIFI, current_rate_5G, l_SEW, l_phone, l_cloud])
        self._logger.log("state " + str(self._state),2)
        ...
        self._logger.log("state_env " + str(state),1)
    ...
    def compute_cost(self, system, state, configuration, action):
        ...
        cost = self._weights["w_exec"] * cost_exec*lat_rate + self._weights["w_config"] * cost_config + \
               ...
               self._weights["w_energy_SEW"] * energy_cost_normalized_SEW + self._weights["w_energy_Phone"] \
    ...
    def convert_to_original_state_with_configs(self, state):
        ...
        if l_cloud_norm is not None:
            l_cloud = l_cloud_norm * (self._elements_max[4] - self._elements_min[4]) + self._elements_min[4]
        else:
        ...
        return [r_wifi, r_5G, l_SEW, l_phone, l_cloud]
    ...
    def normalize_state_with_all_configs(self, state):
        ...
        return [r_wifi_norm,r_5G_norm,l_SEW_norm,l_phone_norm,l_cloud_norm]


EnvironmentSEWDQN.register()
