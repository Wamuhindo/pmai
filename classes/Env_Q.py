...
class EnvironmentSEWQ(Environment, Serializable):
    ...
    def step(self, _action):
        ...
        normalized_state = self.normalize_state(self._state) #convert_state_to_index(self.normalize_state(self._state), 11)
    ...
    def _step_in_env(self, env_, chosen_action):
        ...
        env._previous_state = [r_WIFI,r_5G,100,l_SEW,l_phone,l_cloud]
